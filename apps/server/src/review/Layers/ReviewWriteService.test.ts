...
const asAuthSessionId = (value: string) => AuthSessionId.makeUnsafe(value);
const asReviewSessionId = (value: string) => ReviewSessionId.makeUnsafe(value);
const asChunkId = (value: string) => ReviewChunkId.makeUnsafe(value);
...
describe("ReviewWriteService", () => {
  ...
  it("blocks submission when any pending inline draft anchor is stale", async () => {
    ...
    drafts.set("github-review-draft-stale", {
      id: GitHubReviewDraftId.makeUnsafe("github-review-draft-stale"),
      sessionId: session.sessionId,
      authSessionId,
      draftKind: "inline-comment",
  ...
  it("submits accumulated inline drafts and a summary as one GitHub review", async () => {
    ...
    drafts.set("github-review-draft-inline", {
      id: GitHubReviewDraftId.makeUnsafe("github-review-draft-inline"),
      sessionId: session.sessionId,
      authSessionId,
      draftKind: "inline-comment",
      anchor: makeAnchor(),
    ...
    drafts.set("github-review-draft-summary", {
      id: GitHubReviewDraftId.makeUnsafe("github-review-draft-summary"),
      sessionId: session.sessionId,
      authSessionId,
