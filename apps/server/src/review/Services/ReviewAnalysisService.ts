...
import { hashReviewText } from "../../../../../packages/shared/src/review.ts";
import type {
...
export class ReviewAnalysisService extends ServiceMap.Service<
...
function buildArtifact(context: ReviewAnalysisContext, now: string): ReviewAnalysisArtifact {
  ...
  return {
    id: ReviewAnalysisArtifactId.makeUnsafe(`review-analysis-${randomUUID()}`),
