...
const asReviewGroupId = (value: string) => ReviewGroupId.make(value);
const asReviewFileId = (value: string) => ReviewFileId.make(value);
const asReviewChunkId = (value: string) => ReviewChunkId.make(value);
