...
const STRICT_PROVIDER_LIFECYCLE_GUARD = process.env.FENRIR_STRICT_PROVIDER_LIFECYCLE_GUARD !== "0";
...
const make = Effect.fn("make")(function* () {
  ...
  const isGitRepoForThread = Effect.fn("isGitRepoForThread")(function* (threadId: ThreadId) {
    ...
    return yield* sourceControl.isSupportedWorkspace(workspaceCwd);
  });
