import {
  ...
  ThreadMcpServersSetPayload as ContractsThreadMcpServersSetPayloadSchema,
...
export const ThreadMcpServersSetPayload = ContractsThreadMcpServersSetPayloadSchema;
