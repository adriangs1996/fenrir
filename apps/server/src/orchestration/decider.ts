    ...
    case "project.meta.update": {
      ...
      return {
        ...
        payload: {
          ...
          ...(command.globalScriptDefaults !== undefined
            ? { globalScriptDefaults: command.globalScriptDefaults }
            : {}),
    ...
    case "thread.create": {
      ...
      return {
        ...
        payload: {
          ...
          mcpServerIds: command.mcpServerIds ?? [],
          branch: command.branch,
          worktreePath: command.worktreePath,
          visibility: command.visibility ?? "normal",
          owner: command.owner ?? null,
          deleteOnSettled: command.deleteOnSettled ?? false,
          createdAt: command.createdAt,
          updatedAt: command.createdAt,
        },
      };
