...
import { GitCommandError, type GitBranch } from "@fenrir/contracts";
import { dedupeRemoteBranchesWithLocalMatches } from "@fenrir/shared/git";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `fenrir-git-trace2-${process.pid}-`,
    suffix: ".json",
  });
