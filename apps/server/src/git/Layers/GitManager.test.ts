...
> {
  return Effect.gen(function* () {
    const remoteDir = yield* makeTempDir("fenrir-git-remote-");
...
function createGitHubCliWithFakeGh(scenario: FakeGhScenario = {}): {
  ...
  const execute: GitHubCliShape["execute"] = (input) => {
    ...
    if (args[0] === "pr" && args[1] === "create") {
      return Effect.succeed({
        stdout:
          (scenario.createdPrUrl ?? "https://github.com/fenrir-org/codething-mvp/pull/101") + "\n",
        stderr: "",
        code: 0,
        signal: null,
        timedOut: false,
    ...
    if (args[0] === "pr" && args[1] === "view") {
      const pullRequest: FakePullRequest = scenario.pullRequest ?? {
        number: 101,
        title: "Pull request",
        url: "https://github.com/fenrir-org/codething-mvp/pull/101",
        baseRefName: "main",
...
function makeManager(input?: {
  ...
  const ServerConfigLayer = ServerConfig.layerTest(process.cwd(), {
    prefix: "fenrir-git-manager-test-",
  });
...
const GitManagerTestLayer = GitCoreLive.pipe(
  Layer.provide(ServerConfig.layerTest(process.cwd(), { prefix: "fenrir-git-manager-test-" })),
  Layer.provideMerge(NodeServices.layer),
);
...
it.layer(GitManagerTestLayer)("GitManager", (it) => {
  it.effect("status includes PR metadata when branch already has an open PR", () =>
    Effect.gen(function* () {
      const repoDir = yield* makeTempDir("fenrir-git-manager-");
  ...
  it.effect("status returns an explicit non-repo result for non-git directories", () =>
    Effect.gen(function* () {
      const cwd = yield* makeTempDir("fenrir-git-manager-non-repo-");
      const { manager } = yield* makeManager();
  ...
  it.effect("status briefly caches repeated lookups for the same cwd", () =>
    Effect.gen(function* () {
      ...
      const existingPr = {
        number: 113,
        title: "Cached PR",
        url: "https://github.com/fenrir-org/codething-mvp/pull/113",
        baseRefName: "main",
              ...
              JSON.stringify([
                {
                  ...
                  url: "https://github.com/fenrir-org/fenrir/pull/1661",
                  baseRefName: "main",
                  headRefName: "main",
                  state: "OPEN",
                  ...
                  headRepository: {
                    nameWithOwner: "lnieuwenhuis/fenrir",
                  },
                  headRepositoryOwner: {
                    login: "lnieuwenhuis",
                  },
  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        yield* runGit(repoDir, ["checkout", "-b", "fenrir/pr-488/statemachine"]);
              ...
              JSON.stringify([
                {
                  ...
                  url: "https://github.com/fenrir-org/codething-mvp/pull/488",
                  baseRefName: "main",
        ...
        const status = yield* manager.status({ cwd: repoDir });
        expect(status.branch).toBe("fenrir/pr-488/statemachine");
        expect(status.pr).toEqual({
          number: 488,
          title: "Rebase this PR on latest main",
          url: "https://github.com/fenrir-org/codething-mvp/pull/488",
    ...
    () =>
      Effect.gen(function* () {
        ...
        yield* runGit(repoDir, [
          "config",
          "remote.origin.url",
          "git@github.com:fenrir-org/codething-mvp.git",
        ]);
        ...
        const { manager, ghCalls } = yield* makeManager({
          ghScenario: {
            prListByHeadSelector: {
              "effect-atom": JSON.stringify([
                {
                  number: 1618,
                  title: "Correct PR",
                  url: "https://github.com/fenrir-org/fenrir/pull/1618",
                  baseRefName: "main",
              ...
              "upstream/effect-atom": JSON.stringify([
                {
                  number: 1518,
                  title: "Wrong PR",
                  url: "https://github.com/fenrir-org/fenrir/pull/1518",
                  baseRefName: "main",
              ...
              "fenrir-org:effect-atom": JSON.stringify([]),
              "my-org/upstream:effect-atom": JSON.stringify([]),
              "fenrir-org:upstream/effect-atom": JSON.stringify([
                {
                  number: 1518,
                  title: "Wrong PR",
                  url: "https://github.com/fenrir-org/fenrir/pull/1518",
        ...
        expect(
          ghCalls.some((call) => call.includes("pr list --head fenrir-org:upstream/effect-atom ")),
        ).toBe(false);
        expect(
          ghCalls.some((call) =>
            ...
            JSON.stringify([
              {
                number: 22,
                title: "Merged PR",
                url: "https://github.com/fenrir-org/codething-mvp/pull/22",
                baseRefName: "main",
            ...
            JSON.stringify([
              {
                number: 45,
                title: "Merged PR",
                url: "https://github.com/fenrir-org/codething-mvp/pull/45",
                baseRefName: "main",
              ...
              },
              {
                number: 46,
                title: "Open PR",
                url: "https://github.com/fenrir-org/codething-mvp/pull/46",
                baseRefName: "main",
                headRefName: "feature/status-open-over-merged",
                state: "OPEN",
                updatedAt: "2026-01-30T10:00:00Z",
            ...
            JSON.stringify([
              {
                number: 23,
                title: "Merged PR",
                url: "https://github.com/fenrir-org/codething-mvp/pull/23",
              ...
              JSON.stringify([
                {
                  ...
                  url: "https://github.com/fenrir-org/codething-mvp/pull/77",
                  baseRefName: "main",
            ...
            JSON.stringify([
              {
                ...
                url: "https://github.com/fenrir-org/codething-mvp/pull/303",
                baseRefName: "main",
            ...
            JSON.stringify([
              {
                number: 42,
                title: "Existing PR",
                url: "https://github.com/fenrir-org/codething-mvp/pull/42",
                baseRefName: "main",
              ...
              JSON.stringify([
                {
                  ...
                  url: "https://github.com/fenrir-org/codething-mvp/pull/142",
                  baseRefName: "main",
                  headRefName: "statemachine",
                  state: "OPEN",
                  isCrossRepository: true,
  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        yield* runGit(repoDir, ["remote", "add", "fork-seed", forkDir]);
        yield* runGit(repoDir, ["push", "-u", "fork-seed", "statemachine"]);
        yield* runGit(repoDir, ["checkout", "-b", "fenrir/pr-142/statemachine"]);
        yield* runGit(repoDir, ["branch", "--set-upstream-to", "fork-seed/statemachine"]);
        yield* runGit(repoDir, [
          "config",
          "remote.fork-seed.url",
        ...
        const { manager, ghCalls } = yield* makeManager({
          ghScenario: {
            prListByHeadSelector: {
              "fenrir/pr-142/statemachine": JSON.stringify([]),
              statemachine: JSON.stringify([
                {
                  number: 41,
                  title: "Unrelated same-repo PR",
                  url: "https://github.com/fenrir-org/codething-mvp/pull/41",
                  baseRefName: "main",
                  headRefName: "statemachine",
                },
              ]),
            ...
            JSON.stringify([
              {
                number: 88,
                title: "Add stacked git actions",
                url: "https://github.com/fenrir-org/codething-mvp/pull/88",
                baseRefName: "main",
              ...
              JSON.stringify([
                {
                  number: 188,
                  title: "Add stacked git actions",
                  url: "https://github.com/fenrir-org/codething-mvp/pull/188",
                  baseRefName: "main",
                  headRefName: "feature/no-fork-match",
                  state: "OPEN",
  ...
  it.effect("creates cross-repo PRs with the fork owner selector and default base branch", () =>
    Effect.gen(function* () {
      ...
      yield* runGit(repoDir, ["commit", "-m", "Feature commit"]);
      yield* runGit(repoDir, ["push", "-u", "fork-seed", "statemachine"]);
      yield* runGit(repoDir, ["checkout", "-b", "fenrir/pr-91/statemachine"]);
      yield* runGit(repoDir, ["branch", "--set-upstream-to", "fork-seed/statemachine"]);
      yield* runGit(repoDir, [
        "config",
        "remote.fork-seed.url",
      ...
      const { manager, ghCalls } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            number: 64,
            title: "Local PR",
            url: "https://github.com/fenrir-org/codething-mvp/pull/64",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            ...
            url: "https://github.com/fenrir-org/codething-mvp/pull/177",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            number: 81,
            title: "Fork PR",
            url: "https://github.com/fenrir-org/codething-mvp/pull/81",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            number: 82,
            title: "Local Fork PR",
            url: "https://github.com/fenrir-org/codething-mvp/pull/82",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            ...
            url: "https://github.com/fenrir-org/fenrir/pull/642",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            ...
            url: "https://github.com/fenrir-org/codething-mvp/pull/78",
            baseRefName: "main",
  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const { manager } = yield* makeManager({
          ghScenario: {
            pullRequest: {
              number: 91,
              title: "Fork main PR",
              url: "https://github.com/fenrir-org/codething-mvp/pull/91",
              baseRefName: "main",
              headRefName: "main",
              state: "open",
              isCrossRepository: true,
        ...
        expect(result.branch).toBe("fenrir/pr-91/main");
        expect(result.worktreePath).not.toBeNull();
  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const { manager } = yield* makeManager({
          ghScenario: {
            pullRequest: {
              ...
              url: "https://github.com/fenrir-org/codething-mvp/pull/92",
              baseRefName: "main",
              headRefName: "main",
              state: "open",
              isCrossRepository: true,
        ...
        expect(result.branch).toBe("fenrir/pr-92/main");
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            ...
            url: "https://github.com/fenrir-org/codething-mvp/pull/83",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            ...
            url: "https://github.com/fenrir-org/codething-mvp/pull/184",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            number: 79,
            title: "Root-only PR",
            url: "https://github.com/fenrir-org/codething-mvp/pull/79",
            baseRefName: "main",
            ...
            JSON.stringify([
              {
                ...
                url: "https://github.com/fenrir-org/codething-mvp/pull/201",
                baseRefName: "main",
