...
interface BoundAcpClient {
  readonly client: EffectAcpClient.AcpClientShape;
  readonly initialize: (
  ...
  readonly cancel: (sessionId: string) => Effect.Effect<void, EffectAcpErrors.AcpError>;
  readonly rawRequest: (
    method: string,
    payload: unknown,
  ) => Effect.Effect<unknown, EffectAcpErrors.AcpError>;
...
function bindAcpClient(acpContext: Context.Context<EffectAcpClient.AcpClient>): BoundAcpClient {
  ...
  return {
    client,
    initialize: (payload) =>
      client.agent.initialize(payload) as Effect.Effect<
        EffectAcpSchema.InitializeResponse,
        EffectAcpErrors.AcpError
      >,
    authenticate: (payload) =>
      client.agent.authenticate(payload) as Effect.Effect<
        EffectAcpSchema.AuthenticateResponse,
        EffectAcpErrors.AcpError
      >,
    loadSession: (payload) =>
      client.agent.loadSession(payload) as Effect.Effect<
        EffectAcpSchema.LoadSessionResponse,
        EffectAcpErrors.AcpError
      >,
    createSession: (payload) =>
      client.agent.createSession(payload) as Effect.Effect<
        EffectAcpSchema.NewSessionResponse,
        EffectAcpErrors.AcpError
      >,
    setSessionConfigOption: (payload) =>
      client.agent.setSessionConfigOption(payload) as Effect.Effect<
        EffectAcpSchema.SetSessionConfigOptionResponse,
        EffectAcpErrors.AcpError
      >,
    prompt: (payload) =>
      client.agent.prompt(payload) as Effect.Effect<
        EffectAcpSchema.PromptResponse,
        EffectAcpErrors.AcpError
      >,
    cancel: (sessionId) =>
      client.agent.cancel({ sessionId }) as Effect.Effect<void, EffectAcpErrors.AcpError>,
    rawRequest: (method, payload) =>
      client.raw.request(method, payload) as Effect.Effect<unknown, EffectAcpErrors.AcpError>,
    rawNotify: (method, payload) =>
      client.raw.notify(method, payload) as Effect.Effect<void, EffectAcpErrors.AcpError>,
  };
}
...
> =>
  Effect.gen(function* () {
    ...
    const acpClientLayer = EffectAcpClient.layerChildProcess(child, {
    ...
    }) as Layer.Layer<EffectAcpClient.AcpClient>;
    ...
    yield* acp.client.handleSessionUpdate((notification: EffectAcpSchema.SessionNotification) =>
      handleSessionUpdate({
        queue: eventQueue,
        modeStateRef,
        toolCallsRef,
    ...
    }) as Effect.Effect<AcpStartedState, EffectAcpErrors.AcpError>;
    ...
    const validateConfigOptionValue = (
      ...
      }) as Effect.Effect<void, EffectAcpErrors.AcpError>;
    ...
    const setConfigOption = (
      ...
      ) as Effect.Effect<EffectAcpSchema.SetSessionConfigOptionResponse, EffectAcpErrors.AcpError>;
    ...
    return {
      handleRequestPermission: acp.client.handleRequestPermission,
      handleElicitation: acp.client.handleElicitation,
      handleReadTextFile: acp.client.handleReadTextFile,
      handleWriteTextFile: acp.client.handleWriteTextFile,
      handleCreateTerminal: acp.client.handleCreateTerminal,
      handleTerminalOutput: acp.client.handleTerminalOutput,
      handleTerminalWaitForExit: acp.client.handleTerminalWaitForExit,
      handleTerminalKill: acp.client.handleTerminalKill,
      handleTerminalRelease: acp.client.handleTerminalRelease,
      handleSessionUpdate: acp.client.handleSessionUpdate,
      handleElicitationComplete: acp.client.handleElicitationComplete,
      handleUnknownExtRequest: acp.client.handleUnknownExtRequest,
      handleUnknownExtNotification: acp.client.handleUnknownExtNotification,
      handleExtRequest: acp.client.handleExtRequest,
      handleExtNotification: acp.client.handleExtNotification,
      start: () => start,
      ...
      prompt: (payload) =>
        getStartedState.pipe(
          Effect.flatMap((started) => {
            ...
            return closeActiveAssistantSegment({
              ...
              Effect.andThen(
                runLoggedRequest("session/prompt", requestPayload, acp.prompt(requestPayload)),
              ),
              Effect.tap(() =>
        ...
        ) as Effect.Effect<EffectAcpSchema.PromptResponse, EffectAcpErrors.AcpError>,
      cancel: getStartedState.pipe(
        Effect.flatMap((started) => acp.cancel(started.sessionId)),
      ) as Effect.Effect<void, EffectAcpErrors.AcpError>,
      setMode: (modeId) =>
      ...
      request: (method, payload) =>
        runLoggedRequest(method, payload, acp.rawRequest(method, payload)),
      notify: acp.rawNotify,
      shutdown: Effect.ignore(
        child.isRunning.pipe(Effect.flatMap((running) => (running ? child.kill() : Effect.void))),
