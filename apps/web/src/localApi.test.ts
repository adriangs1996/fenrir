...
const rpcClientMock = {
  ...
  gitDiff: {
    ...
    loadChangeRequestReviewThreads: vi.fn(),
    commentChangeRequestLines: vi.fn(),
    revertChangeRequestLines: vi.fn(),
  },
  vcs: {
    pull: vi.fn(),
    refreshStatus: vi.fn(),
