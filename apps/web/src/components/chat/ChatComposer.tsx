                  ...
                  >
                    <div className="min-w-0">
                      ...
                      <div className="mt-1.5 flex min-w-0 flex-wrap items-center gap-1.5">
                        ...
                        <Badge
                          variant={
                            server.source === "fenrir" ? "info" : "secondary"
                          }
                          size="sm"
                        >
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        setServerSelected(server.id, Boolean(checked))
                      }
                    />
                  </div>
                );
...
export const ChatComposer = memo(
  forwardRef<ChatComposerHandle, ChatComposerProps>(
    function ChatComposer(props, ref) {
      ...
      const removePendingEditorContext = useEditorStore(
        (s) => s.removePendingContext,
      );
      ...
      const selectedProvider: ProviderSelectionKind =
        lockedProvider ?? unlockedSelectedProvider;
      const selectedProviderInstanceId = useMemo<ProviderInstanceId>(() => {
        const draftSelection =
          composerDraft.providerInstanceIdByProvider[selectedProvider];
        ...
        if (
          ...
          matchesSelectedProvider(
            getProviderSnapshotByInstanceId(providerStatuses, draftSelection),
          )
        ) {
        ...
        if (
          sessionSelection &&
          matchesSelectedProvider(
            getProviderSnapshotByInstanceId(providerStatuses, sessionSelection),
          )
        ) {
      ...
      const searchableModelOptions = useMemo(() => {
        const availableProviders = getSelectableProviderKinds(
          providerStatuses,
        ).filter(
        ...
        return availableProviders.flatMap((provider) =>
          (modelOptionsByProvider[provider] ?? []).map(({ slug, name }) => ({
            ...
            searchProvider: getProviderOptionLabel(
              providerStatuses,
              provider,
            ).toLowerCase(),
          })),
      ...
      useLayoutEffect(() => {
        ...
        const measureFooterCompactness = () => {
          ...
          const heuristicFooterCompact = shouldUseCompactComposerFooter(
            composerFormWidth,
            {
          ...
          const footerContentWidth = resolveComposerFooterContentWidth({
            ...
            paddingLeft: footerStyle
              ? Number.parseFloat(footerStyle.paddingLeft)
              : null,
            paddingRight: footerStyle
          ...
          const fitInput = {
            footerContentWidth,
            leadingContentWidth:
              composerFooterLeadingRef.current?.scrollWidth ?? null,
                ...
                <div className="rounded-t-[19px] border-b border-border/65 bg-muted/20">
                  ...
                  activePendingApproval.detail ? (
                    <div className="px-4 pb-3 sm:px-5 sm:pb-4">
                      <ComposerPendingApprovalCommand
                ...
                >
                  ...
                  >
                    ...
                    {providerInstanceOptions.length > 1 ? (
                      <Select
                        ...
                        onValueChange={(value) =>
                          value && onProviderInstanceSelect(value)
                        }
                      >
                        <SelectTrigger
                          size="sm"
                  ...
                  >
                    <ComposerFooterPrimaryActions
                      ...
                      hasSendableContent={
                        composerSendState.hasSendableContent &&
                        props.mcpCompatibilityMessage === null
                      }
