...
export const CLIENT_SETTINGS_STORAGE_KEY = "fenrir:client-settings:v1";
export const SAVED_ENVIRONMENT_REGISTRY_STORAGE_KEY = "fenrir:saved-environment-registry:v1";
