// This file mostly exists because we want dev mode to say "Fenrir (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "Fenrir (Dev)" : "Fenrir (Alpha)";
const APP_BUNDLE_ID = isDevelopment ? "com.fenrir.app.dev" : "com.fenrir.app";
